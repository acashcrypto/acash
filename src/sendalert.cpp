// Copyright (c) 2018-2019 The ACASH Community
...
./acashd -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and incompatible with the Sapling network upgrade. Please update to a recent version of ACASH (2.0.1 or later).";
