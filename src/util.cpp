...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "acash.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override acash.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "acashd.pid"));
...
{
    return "\n" +
           FormatParagraph(strprintf(_("In order to ensure you are adequately protecting your privacy when using ACASH, please see <%s>."),
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2017-%i ACASH Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
