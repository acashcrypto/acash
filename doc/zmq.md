...
For instance:
    ...
    $ acashd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/acashd.tx.raw
...
From the perspective of acashd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into acashd directly. Furthermore, no information is
